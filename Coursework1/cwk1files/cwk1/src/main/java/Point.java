...
public class Point {
  ...
  private static final double MEAN_EARTH_RADIUS = 6.371009e+6;
   ...
   //I start by initializing a new point object with given values. 
  public Point(ZoneDateTime ts, double lon, double lat, double elev){
  ...
  //method to return thr timestamp. 
